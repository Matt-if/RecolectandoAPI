...
public class UserRequest {
    ...
    @Email(message = "formato de email debe ser valido")
    private String username;
    @NotBlank(message = "contra no puede estar vacia")
    @Size(min = 4, message = "la contra debe tener al menos 4 caracteres")
